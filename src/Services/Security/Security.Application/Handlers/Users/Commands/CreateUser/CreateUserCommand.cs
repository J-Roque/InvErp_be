...
public record CreateUserCommand(CreateUserInput User, UserContextDto UserContext) : ICommand<CreateUserResult>;
...
public class CreateUserCommandValidator : AbstractValidator<CreateUserCommand>
{
    public CreateUserCommandValidator()
    {
        ...
        RuleFor(x => x.User.Password).NotEmpty().WithMessage("El campo Password es obligatorio");
